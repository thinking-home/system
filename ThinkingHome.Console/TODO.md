...
- [ ] сделать контейнеры обработчиков (для удобного поиска), и сет обработчиков (для массового выполнения)
- [ ] определиться с терминологией клиент-серверной шины сообщений
- [ ] протестировать серверные события шины сообщений
