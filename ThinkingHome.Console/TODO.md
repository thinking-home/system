...
- [ ] вместо метода отображения ошибки сделать раздел-заглушку 
- [ ] выпилить обработку ошибок в методе `start`
...
- [x] web-ui (~~app list~~)
- [ ] scripts UI(~~запуск скриптов~~, ~~сохранение~~, ~~удаление~~, ~~fullscreen~~, ~~theme~~, подписка на события)
