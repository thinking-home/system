...
- [ ] обрубать слэши команд telegram + валидировать (?)
- [ ] написать тесты на парсинг команд telegram
- [ ] написать в документацию, что бот должен быть админом, чтобы отправлять сообщения пользователям по имени
- [ ] сделать переподключение бота и обработку ошибок
