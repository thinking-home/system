...
var TmpPigToast = function (e) {
    var _a = e.msg, topic = _a.topic, guid = _a.guid, timestamp = _a.timestamp, _b = _a.data, name = _b.name, size = _b.size, counter = e.counter;
...
var TmpSection = function () {
    var _a = (0,_thinking_home_ui__WEBPACK_IMPORTED_MODULE_1__.useAppContext)(), send = _a.messageHub.send, showInfo = _a.toaster.showInfo;
    var _b = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0), value = _b[0], setValue = _b[1];
    (0,_thinking_home_ui__WEBPACK_IMPORTED_MODULE_1__.useMessageHandler)(TOPIC, tmpPigDecoder, function (msg) {
    ...
    var onClick = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
        ...
        send(TOPIC, { name: name, size: value });
    }, [send, value]);
    var onIncement = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
        setValue(value + 1);
    }, [value, setValue]);
