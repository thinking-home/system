...
var TmpSection = function () {
    ...
    var controller = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function () { return new AbortController(); }, []);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
        api.get(tmpResponseDecoder, { url: url, signal: controller.signal })
            .then(setList, function (e) { return console.error(e); });
        return function () { return controller.abort(); };
    }, [controller]);
    var cancel = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () { return controller.abort(); }, [controller]);
