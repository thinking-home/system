...
В ответ на клиент возвращается список чатов. Порядок записей в ответе фиксирован: они идут по убыванию поля `date`, самая новая запись — первой. Параметров сортировки у запроса нет.
