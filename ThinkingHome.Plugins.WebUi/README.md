...
Реализована общая разметка страницы (навигационное меню и область для контента), отображение содержимого разделов интерфейса и роутинг (механизм перехода между разделами, в зависимости от адреса в адресной строке).
