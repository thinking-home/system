...
namespace ThinkingHome.Plugins.WebServer.Messages
{
    public static class MessageHubExtensions
    {
        ...
        {
            return MessageHub.InternalSend(context.Clients.All, channel, data);
        }
    }
    ...
    public class MessageHub : Hub
    {
        ...
        {
            return InternalSend(Clients.All, channel, data);
        }

        internal static event HubMessageHandlerDelegate Message;

        internal static Task InternalSend(IClientProxy clients, string channel, object data)
        {
